...
<html lang="en">
  ...
  <body class="text-white">
    ...
    <nav style="background-color: cadetblue;" class="navbar navbar-toggleable-md navbar-inverse fixed-top main_menu_bg navbar navbar-expand-lg navbar-fixed-top">
      <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <a class="navbar-brand" href="index.php"><h1 style="margin-left: 80px;">Accomodation Finder</h1></a>
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav " style="margin-right:10%">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#form"><h4>Registration</h4><span class="sr-only">(current)</span></a>  
          </li>
          <?php
                session_start();
      ...
      <form action = "submit.php" method = "post">
        ...
        <div class="row">
          <div class="col-xs-12 offset-lg-6 offset-md-6 offset-sm-6 offset-xs-6">
            <div >
              <button type="submit" class="btn btn-primary" id="sub" style="margin-bottom: 30px;">Submit</button>
            </div>
          </div>
        </div>
      </form>
